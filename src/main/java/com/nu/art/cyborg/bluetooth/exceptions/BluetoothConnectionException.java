 ...
 */
package com.nu.art.cyborg.bluetooth.exceptions;
...
public class BluetoothConnectionException
	...
	public BluetoothConnectionException(String reason, Throwable e) {
		super(reason, e);
	}

	public BluetoothConnectionException(String reason) {
		super(reason);
	}
}
